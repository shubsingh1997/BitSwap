...
exports.datewiseCommision = function (req, res) {
...
exports.datewiseLogs = function (req, res) {
    var start_date = req.body.start_date;
    var end_date = req.body.end_date;
